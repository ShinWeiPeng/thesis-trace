...
def apply_runtime_grants(connection: psycopg.Connection) -> None:
    ...
    connection.execute("REVOKE ALL PRIVILEGES ON SCHEMA access,research,workflow,public FROM thesis_trace_api,thesis_trace_collector,thesis_trace_ai_worker")
    connection.execute("REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA access,research,workflow FROM thesis_trace_api,thesis_trace_collector,thesis_trace_ai_worker")
    connection.execute("REVOKE ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA access,research,workflow FROM thesis_trace_api,thesis_trace_collector,thesis_trace_ai_worker")
    connection.execute("GRANT USAGE ON SCHEMA access,research,workflow TO thesis_trace_api")
